...
def cSE_block(input_x):
    ...
    x = Dense(K.int_shape(input_x)[-1]//16,activation='relu',kernel_initializer="he_normal")(x)
    x = Dense(K.int_shape(input_x)[-1],activation='sigmoid',kernel_initializer="he_normal")(x)
