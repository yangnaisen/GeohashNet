...
from .data_augmentation.augmentation import random_channel_shift
...
class InriaDataLoader(Sequence):
    def __init__(
        ...
        self.images_filenames = [
            os.path.join(x_set_dir, item) for item in file_names
        ]
        self.labels_filenames = [
            os.path.join(y_set_dir, item) for item in file_names
        ]
