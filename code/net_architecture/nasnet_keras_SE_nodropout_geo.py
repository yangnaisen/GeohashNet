...
def NASNet(input_shape=None,
    ...
    if use_bn:
        x = layers.BatchNormalization(
            axis=channel_dim, momentum=bn_momentum, epsilon=1e-3, name='stem_bn1')(x)

    geohash_input = kwargs['geohash_input']
    ...
    model = models.Model(inputs=[img_input,geohash_input], outputs=x, name='NASNet')
